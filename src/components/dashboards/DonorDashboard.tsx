...
export const DonorDashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-bold text-slate-900 mb-2">Donor Dashboard</h1>
        <p className="text-slate-600">Track your impact and manage your humanitarian contributions</p>
      </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-semibold text-slate-900">Funded Projects</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <h3 className="text-lg font-semibold text-slate-900 mb-4">Recent Impact</h3>
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              <div className="w-2 h-2 bg-green-500 rounded-full mt-2"></div>
              <div>
                <p className="font-medium text-slate-900">Medical supplies delivered</p>
                <p className="text-sm text-slate-600">150 trauma kits reached Kyiv Emergency Center</p>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">Odesa Training Center 60% complete</p>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className="font-medium text-slate-900">New thank you message</p>
                <p className="text-sm text-slate-600">From children at Lviv Hospital</p>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <h3 className="text-lg font-semibold text-slate-900 mb-4">Geographic Impact</h3>
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              <div className="flex items-center space-x-2">
                <div className="w-3 h-3 bg-blue-500 rounded-full"></div>
                <span className="text-slate-700">Kyiv Region</span>
              </div>
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-slate-700">Lviv Region</span>
              </div>
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-slate-700">Kharkiv Region</span>
              </div>
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-slate-700">Odesa Region</span>
              </div>
