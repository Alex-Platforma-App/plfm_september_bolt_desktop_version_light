...
import { FileText, Package, Activity, CheckCircle, Edit, HeadphonesIcon } from 'lucide-react';
...
export const NonprofitDashboard: React.FC = () => {
  const cards = [
    {
      ...
      description: 'Aid requests awaiting your approval',
      value: '12',
    ...
    },
    {
      ...
      description: 'Latest distributions and operations',
      value: '23',
      subtitle: 'This week',
    ...
    },
    {
      ...
      description: 'Process pending aid requests',
      value: 'Approve',
    ...
    },
    {
      ...
      description: 'Modify stock levels and add items',
      value: 'Update',
    ...
    },
    {
      ...
      description: 'Get help with operations and platform',
      value: 'Support',
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Nonprofit Dashboard</h1>
        <p className="text-gray-600">Manage inventory, requests, and humanitarian operations</p>
      </div>
